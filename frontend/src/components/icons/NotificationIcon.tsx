...
export default function NotificationIcon({ width = 18, height = 18, color = "currentColor", className }: NotificationIconProps) {
  return (
    <svg width={width} height={height} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
      <path opacity="0.4" d="M15.5 18C15.5 19.933 13.933 21.5 12 21.5C10.067 21.5 8.5 19.933 8.5 18" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path>
