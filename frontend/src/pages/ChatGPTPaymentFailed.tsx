...
export function ChatGPTPaymentFailedPage() {
  ...
  return (
    <div className="wallet-payment-result wallet-payment-result--failed wallet-payment-result--chatgpt">
      ...
      <div className="wallet-payment-result__content">
        ...
        >
          ...
          <h2 className="wallet-payment-result__title">خرید اکانت انجام نشد</h2>
