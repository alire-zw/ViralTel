...
export function WalletPaymentFailedPage() {
  ...
  return (
    <div className="wallet-payment-result wallet-payment-result--failed">
      <div className="shop-rise" style={{ '--rise-index': 0 } as CSSProperties}>
        <PageHeader title="پرداخت ناموفق" onBack={handleBack} />
      </div>
      ...
      <div className="wallet-payment-result__content">
        ...
        >
          ...
          <h2 className="wallet-payment-result__title">پرداخت انجام نشد</h2>
          <p className="wallet-payment-result__subtitle">
            تراکنش شما تکمیل نشد یا توسط شما لغو شد. در صورت کسر وجه، طی ۷۲ ساعت به حساب شما
            بازگردانده می‌شود.
          </p>
        </section>
