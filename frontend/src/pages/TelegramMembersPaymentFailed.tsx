...
export function TelegramMembersPaymentFailedPage() {
  ...
  return (
    <div className="wallet-payment-result wallet-payment-result--failed wallet-payment-result--telegram-members">
      ...
      <div className="wallet-payment-result__content">
        ...
        >
          ...
          <h2 className="wallet-payment-result__title">خرید ممبر تلگرام انجام نشد</h2>
