...
export function ChannelViewsPaymentFailedPage() {
  ...
  return (
    <div className="wallet-payment-result wallet-payment-result--failed wallet-payment-result--channel-views">
      ...
      <div className="wallet-payment-result__content">
        ...
        >
          ...
          <h2 className="wallet-payment-result__title">خرید سین کانال انجام نشد</h2>
