...
export function ReactionPaymentFailedPage() {
  ...
  return (
    <div className="wallet-payment-result wallet-payment-result--failed wallet-payment-result--reaction">
      ...
      <div className="wallet-payment-result__content">
        ...
        >
          ...
          <h2 className="wallet-payment-result__title">خرید ری‌اکشن انجام نشد</h2>
