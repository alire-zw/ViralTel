...
export function StarsPaymentSuccessPage() {
  ...
  return (
    <div className="wallet-payment-result wallet-payment-result--success wallet-payment-result--stars">
      ...
      <div className="wallet-payment-result__content">
        ...
        >
          ...
          <h2 className="wallet-payment-result__title">خرید استارز با موفقیت انجام شد</h2>
          <p className="wallet-payment-result__subtitle">
            {order?.quantity
              ? `${order.quantity.toLocaleString('fa-IR')} استارز برای ${recipientLabel} واریز شد.`
        ...
        >
          ...
          {order?.quantity ? (
            <div className="wallet-payment-result__row">
              <span className="wallet-payment-result__row-label">تعداد استارز</span>
              {isLoading ? (
                <span className="wallet-payment-result__skeleton" />
              ) : (
